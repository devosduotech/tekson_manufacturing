...
def get_calendar(from_date=None, to_date=None, days=7):
    ...
    }, ["name", "production_item", "planned_start_date", "status", "qty"], order_by="planned_start_date")
    ...
    for wo in wos:
        ...
        calendar[date_key]["wos"].append({"name": wo.name, "item": wo.production_item, "status": wo.status, "qty": wo.qty})
